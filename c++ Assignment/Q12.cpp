//WAP that solves a quadratic equation (ax^2 + bx + c = 0) using conditional statements to handle all possible cases (real and distinct roots , real , and equal roots , complex roots).
#include <iostream>
#include <cmath>  
using namespace std;
